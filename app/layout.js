...
// Display face for hero headlines only (matches the case study decks)
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      <body className={`antialiased min-h-screen bg-[#F2EBE4] text-[#1c1917] selection:bg-amber-200 ${bodyFont.className} ${displayFont.variable}`}>
        ...
        <header className="w-full max-w-5xl mx-auto flex flex-col md:flex-row md:justify-between md:items-start z-10 relative pt-12 pb-3 gap-6 md:gap-0">
          ...
          <div className="flex flex-col transform md:-rotate-1 origin-left">
            <Link href="/" className="font-display text-lg font-semibold tracking-tight text-stone-900 hover:text-stone-700 transition-colors">
            Vincent Nania
          </Link>
